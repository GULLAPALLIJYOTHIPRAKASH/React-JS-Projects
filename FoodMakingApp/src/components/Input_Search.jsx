...
function Input_Search({handle_Input , query}){
    ...
    return(
        ...
        <div className="recipe-search-center wrapper text-center">
            ...
            <input type="search" onChange={handle_Input} value={query} className="search-cancel-red w-[80%] p-[10px] outline-none bg-[#344742] text-white rounded-[4px]" name="search" id="search" placeholder="Search for the recipes..." />
        </div>
    </div>
        </>
    )
